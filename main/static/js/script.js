window.addEventListener("load", () => {
    ...
    mobileMenuBtn.addEventListener("click", () => {
        if (!menuContainer.hasAttribute("data-mobileMenueActive")) {
            menuContainer.setAttribute("data-mobileMenueActive", "")
            ...
            menuContainer.removeAttribute("data-mobileMenueActive", "")
            mobileMenuBtn.innerHTML = `
